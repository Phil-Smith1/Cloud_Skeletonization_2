...
Input::Input ( string const& p_t, int p_s_1, int p_s_2, bool reg, bool g_d_c_s, int c_s_p, string const& n_t, double n_p, bool aR, int a_s_t, bool m, int m_s_t, bool h, int h_s_t, int r )
{
    pattern_type = p_t;
