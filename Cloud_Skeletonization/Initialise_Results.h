...
void Initialise_Results ( vector<Results>& alphaReeb_results, vector<double>const& alpha_values, vector<Results>& mapper_results, vector<double>const& num_intervals_parameter, vector<double>const& DBSCAN_parameter, Results& hopes_results, double repetitions )
{
