...
void Write_Input ( string const& input_file, Run_Input const& run_input )
{
    ...
    ofs << "Pattern  P_S_1  P_S_2  Reg  G_D_C_S  C_S_Param  Noise_Type  Noise_Parameter  AlphaReeb  AlphaReeb_Simp_Type  Mapper  Mapper_Simp_Type  Hopes  Hopes_Simp_Type  Repetitions" << endl;
